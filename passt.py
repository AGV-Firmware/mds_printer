...
def printer_test(ser,Data):
  ...
  ser.write(b'TEXT 200,75,\"3\",0,1,1,\"Lineowave Technologies"\n')
  #ser.write(b'TEXT 120,100,\"2\",0,1,1,\"Line12342353512141hfckahkjf\"\n')
  temp = "TEXT 65,150,\"3\",0,1,1,\"Date: " +Data[0]     + "    WT B/f Cycle:  " + Data[5]    +"  KG\"\n"
  ser.write(temp.encode("utf-8"))
  temp = "TEXT 65,200,\"3\",0,1,1,\"Start Time: " +Data[2]     + "   WT A/f Cycle:  " + Data[6]    +"  KG\"\n"
  ser.write(temp.encode("utf-8"))
  #ser.write(b'TEXT 65,275,\"3\",0,1,1,\"Starting Time :             Device :       \"\n')
  temp = "TEXT 65,250,\"3\",0,1,1,\"Process No: " + Data[1]  + "   End Time : " + Data[4] + "\"\n"
  ser.write(temp.encode("utf-8"))
  ser.write(b'PRINT 1\n')
